...
enum MultiBoxTargetCgOpInputs {kAnchor, kLabel, kClsPred};
enum MultiBoxTargetCgOpOutputs {kLoc, kLocMask, kCls};
enum MultiBoxTargetCgOpResource {kTempSpace};
}  // namespace mboxtarget_enum

struct MultiBoxTargetCgParam : public dmlc::Parameter<MultiBoxTargetCgParam> {
  ...
  DMLC_DECLARE_PARAMETER(MultiBoxTargetCgParam) {
...
};  // struct MultiBoxTargetCgParam

template<typename xpu, typename DType>
class MultiBoxTargetCgOp : public Operator {
 public:
  explicit MultiBoxTargetCgOp(MultiBoxTargetCgParam param) {
    this->param_ = param;
  }
  ...
  virtual void Forward(const OpContext &ctx,
	...
	for (double pixes = 0.5; pixes <= 300; pixes += 0.5) {
		...
		*/
		...
		using namespace std;
		MultiBoxTargetCgForward(loc_target, loc_mask, cls_target,
 ...
 private:
  MultiBoxTargetCgParam param_;
};  // class MultiBoxTargetCgOp

template<typename xpu>
Operator* CreateOp(MultiBoxTargetCgParam param, int dtype);

#if DMLC_USE_CXX11
class MultiBoxTargetCgProp : public OperatorProperty {
 public:
  ...
  OperatorProperty* Copy() const override {
    MultiBoxTargetCgProp* MultiBoxTargetCg_sym = new MultiBoxTargetCgProp();
    MultiBoxTargetCg_sym->param_ = this->param_;
    return MultiBoxTargetCg_sym;
  }

  std::string TypeString() const override {
    return "_contrib_MultiBoxTargetCg";
  }
